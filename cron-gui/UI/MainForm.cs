...
using Settings = Cron.Properties.Settings;
...
namespace Cron.UI
{
    internal partial class MainForm : Form
    {
        ...
        {             
            actor = Program.CronSystem.ActorSystem.ActorOf(EventWrapper<Blockchain.PersistCompleted>.Props(Blockchain_PersistCompleted));
            Program.CronSystem.StartNode(Settings.Default.P2P.Port, Settings.Default.P2P.WsPort);
        ...
        {
            if (actor != null)
                Program.CronSystem.ActorSystem.Stop(actor);
            ChangeWallet(null);
        }
