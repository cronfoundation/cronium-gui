...
namespace Cron
{
    ...
    {
        public static CronSystem CronSystem;
        ...
        {
            Cron.Cryptography.ECC.ECPoint ecpoint;
            var b = Cron.Cryptography.ECC.ECPoint.TryParse(publicKey,
                Cron.Cryptography.ECC.ECCurve.Secp256r1, out ecpoint);
            var sc = Cron.SmartContract.Contract.CreateSignatureContract(ecpoint);
            return sc.Address; 
        }
    }
}
